...
async def add_cart(
    ...
    destination_dict = destination.__dict__

    cart_item = CartItem(id=get_max_cart_item_id(), destination=destination_dict, destination_type=destination_type, quantity=quantity)
    for cart_item in cart:
